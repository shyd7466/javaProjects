...
public class Calculate {
    ...
    private Calculate() {
        ...
        // Button fonts
        Font btnFont = new Font("Cambria", Font.PLAIN, 28);
        Font smallTxtBtnFont = new Font("Cambria", Font.PLAIN, 24);
        ...
        btnSwitchToScientificMode.setBackground(Color.white.darker());
        btnSwitchToScientificMode.setForeground(Color.blue);
      ...
      //  int j = -1;
        ...
        inText.setFont(new Font("Cambria", Font.PLAIN, 33));
        window.add(inText);
